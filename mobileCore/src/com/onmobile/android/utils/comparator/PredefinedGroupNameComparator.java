...
public class PredefinedGroupNameComparator implements Comparator<PredefinedGroup> {

	private static Collator collator = Collator.getInstance(ComparatorUtility.getDefaultLocale());
	private static Logger logger = Logger.getLogger(PredefinedGroupNameComparator.class);
	...
	@Override
	public int compare(PredefinedGroup first, PredefinedGroup second) {
