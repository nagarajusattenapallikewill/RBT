...
String strStatus;
strStatus = (String)session.getAttribute("StatusInsert");
...
<body>
<form action ="rbt_bulk_selection_updatetask.jsp"   method="post" enctype="multipart/form-data" name="frmBulk">
...
<% System.out.println(strStatus);
   if(strStatus!=null && strStatus.indexOf("SUCCESS")>0)
	{
	   session.removeAttribute("StatusInsert");
	   out.print("<font face=\"Arial\" size=\"3\" color = \"green\" align = \"center\"><b>Request Completed Successfully.</b></font>");
	}
	else if(strStatus!=null && strStatus.indexOf("FAILURE") > 0)
	{
		out.print("<font face=\"Arial\" size=\"3\" color = \"green\" align = \"center\"><b>Request Failed.</b></font>");
	}
	else if(strStatus!=null && strStatus.indexOf("ALREADYEXISTS") > 0)
	{
		out.print("<font face=\"Arial\" size=\"3\" color = \"green\" align = \"center\"><b>File Already Exists.</b></font>");
	}
%>
</td>
</tr>
