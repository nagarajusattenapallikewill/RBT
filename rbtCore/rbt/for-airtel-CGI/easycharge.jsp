...
<%
	...
	String subscriberID = request.getParameter("customer");

	Map<String, String> responseMap = AirtelThirdPartyRequestHandler.processThirdPartyRequest(subscriberID, paramMap, strIP, "easycharge");
