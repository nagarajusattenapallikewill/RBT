...
public class TNBOptinQueueComponent extends ReminderQueueComponent
{
	private static Logger logger = Logger.getLogger(TNBOptinQueueComponent.class);
	
	TnbSubscriberImpl tnbSubscriberImpl = null;
	public TNBOptinQueueComponent(TnbSubscriberImpl tnbSubscriberImpl) 
	{
	...
	{
		ReminderTool.processTNBOptin(tnbSubscriberImpl, smsDay);	
	}
