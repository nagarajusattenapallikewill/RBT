...
public class UGCContentDaemonOzonized extends Ozonized
{

	private static Logger logger = Logger
			.getLogger(UGCContentDaemonOzonized.class);
	private static final String COMPONENT_NAME = "UGCContentDaemon";
