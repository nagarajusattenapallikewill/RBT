...
public class FailedProcessCopyQueueComponent extends SiteQueueComponent
{
    public FailedProcessCopyQueueComponent(ViralSMSTableImpl viralSMSTableImpl, LinkedSubsriberLookup linkedSubsriberLookup)
    {
    ...
    protected void executeQueueComponent(QueueContext queueContext)
    {
        ...
        String response = Utility.processFailedProcessCopyRequest(vst,true,null);
    }
