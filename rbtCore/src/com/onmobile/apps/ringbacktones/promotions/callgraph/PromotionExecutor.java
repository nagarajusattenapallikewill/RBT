 ...
 * 
 */
public class PromotionExecutor extends RbtThreadPoolExecutor
{
	private static Logger logger = Logger.getLogger(PromotionExecutor.class);
	 ...
	 */
	private PromotionExecutor(int corePoolSize, int maximumPoolSize,
	...
	public static class Builder
	{
		...
		public Builder()
		{
			...
			threadFactory = new RbtThreadFactory("PromotionExecutor");
			queuePublisher = new PromotionPublisher(publishInterval,
					TimeUnit.SECONDS);
		}

		public PromotionExecutor build()
		{
			if (logger.isInfoEnabled())
				logger.info("PromotionExecutor Configuration: " + this);

			return new PromotionExecutor(corePoolSize, maximumPoolSize,
