 ...
 * 
 */
public class PromotionConfirmationPublisher extends AbstractQueuePublisher
{
	 ...
	 * @param timeUnit
	 */
	public PromotionConfirmationPublisher(long publishInterval,
			TimeUnit timeUnit)
	{
	...
	protected void publish()
	{
		...
		List<CallGraph> callGraphs = CallGraphDao
				.getByPromotionStatusHavingFrequentCallers(
						PromotionStatus.INITIAL, fetchSize);
		if (callGraphs != null)
		{
			for (CallGraph callGraph : callGraphs)
			{
				PromotionConfirmator promotionConfirmator = new PromotionConfirmator(
						executor, callGraph);
				publish(promotionConfirmator);
			}
		}
	}
	...
	{
		QueuePublisher queuePublisher = new PromotionConfirmationPublisher(
