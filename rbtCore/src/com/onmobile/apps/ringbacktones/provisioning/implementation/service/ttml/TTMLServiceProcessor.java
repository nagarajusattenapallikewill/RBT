package com.onmobile.apps.ringbacktones.provisioning.implementation.service.ttml;
 ...
 *
 */
public class TTMLServiceProcessor extends ServiceProcessor
{
	private static final Logger logger = Logger.getLogger(TTMLServiceProcessor.class);
	 ...
	 * @throws Exception
	 */
	public TTMLServiceProcessor() throws Exception
	{
		super();
	...
	public void processSubStatusRequest(Task task)
	{
		...
		if (library != null && library.getSettings() != null)
			settings = library.getDownloads().getDownloads();
	...
	private Element getSelectionElement(Document document, Task task,
			Download setting, Subscriber subscriber)
	{
		if (setting == null)
			return null;
