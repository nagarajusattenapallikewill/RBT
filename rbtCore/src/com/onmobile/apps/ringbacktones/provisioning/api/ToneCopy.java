 ...
 */
public class ToneCopy extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_tonecopy);
		...
		try
		{
			responseText = AdminFacade.processToneCopyRequest(requestParams);
		}
		catch (Exception e)
		{
