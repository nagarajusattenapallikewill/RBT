 ...
 */
public class SubscriberStatus extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_subsats);
		...
		try
		{
			if(Utility.isComboModeCrmRequest(requestParams))
				responseText = AdminFacade.processComboSubStatusRequest(requestParams);
			else
				responseText = AdminFacade.processSubStatusRequest(requestParams);
		}
		catch (Exception e)
		{
