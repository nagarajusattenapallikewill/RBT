...
/**
 * Used for hitting third party url
 */
public class ESIAQuizForwarder extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_ESIAQuizForward);
		...
		try
		{
			responseText = AdminFacade.processESIAQuizForwarderRequest(requestParams);
		}
		catch (Exception e)
		{
