...
/**
 * @author eswarakrishna.aluri
 *
 */
public class UGCContentUpload extends HttpServlet implements Constants{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_UGC);
		...
		try
		{
			responseText = AdminFacade.processMeraHTRequest(requestParams);
		}
		catch (Exception e)
		{
