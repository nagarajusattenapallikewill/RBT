 ...
 */
public class CrossCopyRdc extends HttpServlet implements Constants
{
	...
	{
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_cross_copy_rdc);
		ResponseEncoder responseEncoder = AdminFacade.getResponseEncoderObject(api_cross_copy_rdc);
		...
		try
		{
			responseText = AdminFacade.processCopyRequest(requestParams);
		}
		catch (Exception e)
		{
