 ...
 */
public class Redirect extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_redirect);
		...
		try
		{
			responseText = AdminFacade.processRedirectRequest(requestParams);
		}
		catch (Exception e)
		{
