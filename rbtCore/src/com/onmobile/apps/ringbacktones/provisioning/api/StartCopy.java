...
/**
 * Servlet implementation class StartCopy
 */
public class StartCopy extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			responseText = AdminFacade.processStartCopyRequest(requestParams);
		}
		catch (Exception e)
		{
