...
public class UGCContentUploadOthers extends HttpServlet implements Constants{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			responseText = AdminFacade.processUGCRequestOthers(requestParams);
		}
		catch (Exception e)
		{
