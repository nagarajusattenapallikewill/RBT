 ...
 */
public class Gift extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_gift);
		...
		try
		{
			responseText = AdminFacade.processGiftRequest(requestParams);
		}
		catch (Exception e)
		{
