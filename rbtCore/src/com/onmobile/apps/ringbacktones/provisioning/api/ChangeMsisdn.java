...
public class ChangeMsisdn extends HttpServlet implements Constants 
{
	static final long serialVersionUID = 1L;

	private ServletConfig servletConfig = null;
	private static final String CLASSNAME = "CHANGE_MSISDN";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		Logger.getLogger(ChangeMsisdn.class).error("RBT:: " + requestParams);
		try
		{
			responseText = AdminFacade.processChangeMsisdnRequest(requestParams);
		}
		catch (Exception e)
		{
			Logger.getLogger(ChangeMsisdn.class).error("RBT:: " + e.getMessage(), e);
		}

		Logger.getLogger(ChangeMsisdn.class).info(CLASSNAME + "RBT:: responseText: " + responseText);
