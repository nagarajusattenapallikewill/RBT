...
/**
 * Servlet implementation class CopyConfirm
 */
public class CopyConfirm extends HttpServlet implements Constants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		HashMap<String, String> requestParams = Utility.getRequestParamsMap(servletConfig, request, response, api_copy);
		...
		try
		{
			responseText = AdminFacade.processCopyConfirmRequest(requestParams);
		}
		catch (Exception e)
		{
