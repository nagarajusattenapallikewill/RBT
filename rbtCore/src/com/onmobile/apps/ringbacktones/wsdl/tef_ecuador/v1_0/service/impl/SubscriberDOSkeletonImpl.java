package com.onmobile.apps.ringbacktones.wsdl.tef_ecuador.v1_0.service.impl;
...
import com.onmobile.apps.ringbacktones.wsdl.tef_ecuador.v1_0.service.DeactivateSubscriber;
import com.onmobile.apps.ringbacktones.wsdl.tef_ecuador.v1_0.service.Rbt_type0;
import com.onmobile.apps.ringbacktones.wsdl.tef_ecuador.v1_0.service.SubscriberDOSkeleton;
import com.onmobile.apps.ringbacktones.wsdl.tef_ecuador.v1_0.service.SubscriberResponse;
import com.onmobile.apps.ringbacktones.wsdl.tef_ecuador.v1_0.service.Subscriber_type0;
...
public class SubscriberDOSkeletonImpl extends SubscriberDOSkeleton {
	...
	@Override
	public SubscriberResponse deactivateSubscriber(DeactivateSubscriber deactivateSubscriber0) {
		SubscriptionRequest request = new SubscriptionRequest(String.valueOf(deactivateSubscriber0.getSubscriberID()));
		request.setMode(deactivateSubscriber0.getMode());
		request.setModeInfo(deactivateSubscriber0.getModeInfo());
		return activateOrDeactivateSubscriber(request, deactivateSubscriber0.getAction());
	}

	private SubscriberResponse activateOrDeactivateSubscriber(SubscriptionRequest request, String action) {
