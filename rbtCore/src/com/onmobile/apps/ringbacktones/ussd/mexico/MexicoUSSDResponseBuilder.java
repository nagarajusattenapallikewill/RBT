...
public class MexicoUSSDResponseBuilder {

	private static Logger basicLogger = Logger.getLogger(MexicoUSSDResponseBuilder.class);
	...
	public static String convertToMessageResponse(String welcomeMessage, List<USSDNode> menu, boolean moreOptionRequired, String moreOptionURL, boolean backOptionRequired ,String backOptionUrl,int startIndex) {
		basicLogger.debug(" convertToResponse "+" welcomemsg : "+welcomeMessage+" moreopturl : "+moreOptionURL+" backurl : "+backOptionUrl);
		int messageLength = USSDConfigParameters.getInstance().getMessageLength();
