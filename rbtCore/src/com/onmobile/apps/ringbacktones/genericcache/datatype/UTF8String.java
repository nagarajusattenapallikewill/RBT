...
public class UTF8String extends StringType
{
	...
	public Object get(ResultSet resultSet, String name) throws SQLException
	{
		...
		if (utf8bytes != null) {
			...
			catch (UnsupportedEncodingException e)
			{
				...
				logger.error("Exception converting the bytes " + output + " into String ", e);
			}
		} else {
	 ...
	 */
	@Override
	public void set(PreparedStatement preparedStatement, Object value, int index)throws SQLException
	{
		if (value instanceof String)
		{
			...
			{
				logger.error("Exception converting the string " + value + " into bytes ", e);
			}
		}
		else
		{
			logger.error("Object value " + value + ". Expected input type is String. Actual type is " + value.getClass().getName());
		}
	}
}
