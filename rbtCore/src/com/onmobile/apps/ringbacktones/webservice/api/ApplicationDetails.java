 ...
 */
/**
 * Servlet implementation class for Servlet: ApplicationDetails
 *
 */
public class ApplicationDetails extends HttpServlet implements WebServiceConstants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			HashMap<String, String> requestParams = Utility.getRequestParamsMap(getServletConfig(), request, response, api_ApplicationDetails);
