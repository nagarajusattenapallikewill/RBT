 ...
 */
/**
 * Servlet implementation class for Servlet: Content
 *
 */
public class Content extends HttpServlet implements WebServiceConstants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			HashMap<String, String> requestParams = Utility.getRequestParamsMap(getServletConfig(), request, response, api_Content);
