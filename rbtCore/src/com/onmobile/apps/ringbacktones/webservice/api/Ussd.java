...
public class Ussd extends HttpServlet implements WebServiceConstants
{
	static final long serialVersionUID = 1L;

	private static Logger logger = Logger.getLogger(Ussd.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			responseText = RBTAdminFacade.getUssdSubscriptionResponseXML(task);
		}
		catch (Exception e)
		{
			logger.error("", e);
