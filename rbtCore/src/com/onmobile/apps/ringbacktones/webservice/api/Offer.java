...
/**
 * This is the servlet class that repsponds with the offer(s) to be presented to
 * the user
 * 
 * @author Sreekar
 */
public class Offer extends HttpServlet implements WebServiceConstants
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			HashMap<String, String> requestParams = Utility.getRequestParamsMap(getServletConfig(), request, response, api_Offer);
