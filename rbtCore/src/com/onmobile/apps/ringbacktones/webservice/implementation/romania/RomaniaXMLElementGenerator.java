 ...
 *
 */
public class RomaniaXMLElementGenerator extends BasicXMLElementGenerator
{
			...
			Subscriber subscriber)
	{
		...
		Element smsElem = generateExitSMSElement(document, task, webServiceSubscriber);
		element.appendChild(smsElem);
