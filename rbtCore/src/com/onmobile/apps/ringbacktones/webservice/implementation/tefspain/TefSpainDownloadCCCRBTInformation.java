...
public class TefSpainDownloadCCCRBTInformation extends TefSpainDownloadRBTInformation 
{

	public TefSpainDownloadCCCRBTInformation() throws ParserConfigurationException 
	{
		super();
	}
