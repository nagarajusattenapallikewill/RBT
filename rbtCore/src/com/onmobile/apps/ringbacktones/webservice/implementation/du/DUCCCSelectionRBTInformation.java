...
public class DUCCCSelectionRBTInformation extends DuSelectionRBTInformation {

	public DUCCCSelectionRBTInformation() throws ParserConfigurationException {
		super();
	}
	...
	protected Element getSubscriberElement(Document document,
		...
		Element element = super.getSubscriberElement(document, task,
				webServicesubscriber, subscriber);
		element = BasicCCCXMLElementGenerator.generateSubscriberElement(
				document, task, element, webServicesubscriber);
	 ...
	 * @see
	 * com.onmobile.apps.ringbacktones.webservice.implementation.BasicRBTInformation
	 * #getSubscriberSettingContentElement(org.w3c.dom.Document,
	 * com.onmobile.apps
	 * .ringbacktones.webservice.common.WebServiceSubscriberSetting)
	 */
	@Override
	protected Element getSubscriberSettingContentElement(Document document,
		...
		Element element = super.getSubscriberSettingContentElement(document,
				task, webServiceSubscriberSetting);
		element = BasicCCCXMLElementGenerator
				.generateSubscriberSettingContentElement(document, task,
						element, webServiceSubscriberSetting);
	...
	protected Element getSubscriberDownloadContentElement(Document document,
		...
		element = BasicCCCXMLElementGenerator
				.generateSubscriberDownloadContentElement(document, task,
						element, webServiceSubscriberDownload);
